...
export const BUILDINGS: Building[] = [
  ...
  // ======================================================================
  B({ id: 'free_tier',     name: 'Free Tier',       icon: '○', kind: 'capacity', vendorScoped: true, servesNodes: 1, maxCount: 1, tier: 'Capacity', cost: 0,     monthlyCost: 0,     computeDraw: 0, computeSupply: 150,      dataRisk: 0, powerKw: 0, color: '#5b7f5b', description: 'Enough to prove the idea works and nothing more. Every provider gives you one.' }),
  B({ id: 'api_tier1',     name: 'API Tier 1',      icon: '①', kind: 'capacity', vendorScoped: true, tier: 'Capacity', cost: 200,   monthlyCost: 0,     computeDraw: 0, computeSupply: 500,     dataRisk: 0, powerKw: 0.5, color: '#4a8f4a', description: 'Unlocked at $5 paid. 500k TPM, $100/mo spend cap. The real first wall you hit.' }),
  B({ id: 'api_tier3',     name: 'API Tier 3',      icon: '③', kind: 'capacity', vendorScoped: true, tier: 'Capacity', cost: 1800,  monthlyCost: 0,     computeDraw: 0, computeSupply: 5000,    dataRisk: 0, powerKw: 4, color: '#4a9f5a', description: 'Unlocked at $100 paid. $1,000/mo cap. Tiers are earned by spending, not by asking.' }),
  B({ id: 'api_tier5',     name: 'API Tier 5',      icon: '⑤', kind: 'capacity', vendorScoped: true, tier: 'Capacity', cost: 14000, monthlyCost: 0,     computeDraw: 0, computeSupply: 40000,   dataRisk: 0, powerKw: 30, color: '#4aaf6a', description: 'Unlocked at $1,000 paid. 40M TPM and a $200,000/mo cap. The ceiling of renting someone else’s compute.' }),
