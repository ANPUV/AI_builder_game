...
export const BUILDINGS: Building[] = [
  ...
  B({ id: 'byo_bay',     name: 'BYO Rack Bay',     icon: '▣', kind: 'capacity',tier: 'Home Lab', cost: 350,   monthlyCost: 34,  computeDraw: 0,  computeSupply: 0, dataRisk: 0, powerKw: 0.45, color: '#7fa860', description: 'A bare rig, a graphics card and a power supply. Cheapest throughput you can own — until the power supply decides otherwise.' }),

  B({ id: 'gaming_pc',   name: 'Gaming PC',        icon: '▤', kind: 'capacity',tier: 'Home Lab', cost: 1200,  monthlyCost: 28,  computeDraw: 0, computeSupply: 90,   dataRisk: 0, powerKw: 0.5, color: '#5b8f4a', priceElasticity: 0.25, description: 'One used 3090 and 24GB of VRAM. The cheapest way to run an 8B at speed, and 24GB is the wall every hobbyist hits.' }),
  B({ id: 'mac_mini',    name: 'Mac Mini M4 Pro',  icon: '▢', kind: 'capacity',tier: 'Home Lab', cost: 2199,  monthlyCost: 9,   computeDraw: 0, computeSupply: 70,   dataRisk: 0, powerKw: 0.15, color: '#a8a8b0', priceElasticity: 0.20, description: '64GB unified at 273 GB/s. Slow, silent, and it holds models a 5090 cannot.' }),
  B({ id: 'framework_pc',name: 'Framework Desktop',icon: '▥', kind: 'capacity',tier: 'Home Lab', cost: 1999,  monthlyCost: 14,  computeDraw: 0, computeSupply: 95,   dataRisk: 0, powerKw: 0.25, color: '#e07a3c', priceElasticity: 0.28, description: 'Strix Halo, 128GB unified with 96GB allocatable to the GPU, 256 GB/s. Best dollars per gigabyte on the shelf.' }),
  ...
  B({ id: 'mac_studio_256',name:'Mac Studio 256GB',icon: '◪', kind: 'capacity',tier: 'Home Lab', cost: 7499,  monthlyCost: 20,  computeDraw: 0, computeSupply: 380,  dataRisk: 0, powerKw: 0.27, color: '#b8b8c0', priceElasticity: 0.26, description: 'What is left after the withdrawal. The 96GB to 256GB upgrade went from $1,600 to $2,000 the same week.' }),
