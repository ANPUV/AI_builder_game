...
const en = {
  ...
  'tour.skipAll': 'Hide tutorial',
  'tour.gotIt': 'Got it',
  'tour.finish': 'Finish',
  'settings.tutorial': 'Guided tutorial',
  'settings.tutorialRestart': 'Show again',
...
const vi: Partial<Record<Key, string>> = {
  ...
  'tour.label': 'Hướng dẫn',
  'tour.stepOf': 'Bước {n} / {total}',
  'tour.skipStep': 'Bỏ qua bước này',
  'tour.skipAll': 'Ẩn hướng dẫn',
  'tour.gotIt': 'Đã hiểu',
  'tour.finish': 'Hoàn tất',
  'settings.tutorial': 'Hướng dẫn từng bước',
  'settings.tutorialRestart': 'Hiện lại',
