...
export default function TopBar({
  ...
  return (
    <div className="topbar">
      ...
      {/* The readouts grow and scroll; the controls after them never do. A
          single flex row put the two in competition, and on a narrow window
          it was Reset that fell off the end. */}
